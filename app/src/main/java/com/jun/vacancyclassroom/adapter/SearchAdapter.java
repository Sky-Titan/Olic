...
public class SearchAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView classroom_name = (TextView) convertView.findViewById(R.id.classroom_name);
        ...
        classroom_name.setText(searchItem.getClassroom());
    ...
    public void addItem(String classroom, String time) {
